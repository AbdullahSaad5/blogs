---
title: I built an abstraction so my agent could write documents. Then I deleted it.
published: true
description: I built a helper library so my agent could make slide decks in a few lines, not 5000-token scripts. It worked, and it made every deck look the same. Why I deleted it and gave the agent more work to do.
tags: ai, agents, llm, programming
cover_image: https://dev-to-uploads.s3.us-east-2.amazonaws.com/uploads/articles/gipm7eirj2jm8l9xq60q.png
canonical_url:
---
...
![The wrapper's cover: dark, generic, left-aligned](https://dev-to-uploads.s3.us-east-2.amazonaws.com/uploads/articles/stepfack7bh702oc8x04.png)

*Before, with the wrapper. Dark, generic, the title shoved off to one side.*

![The same brief without the wrapper: lighter, designed, a clear motif](https://dev-to-uploads.s3.us-east-2.amazonaws.com/uploads/articles/atbqkq3usm3850smusgt.png)

*After, no wrapper. Lighter, a deliberate motif, actually art-directed.*
...
![The wrapper dumps the twenty-row ranking into a table](https://dev-to-uploads.s3.us-east-2.amazonaws.com/uploads/articles/gxf833pzs07dqa3twt0r.png)

*The wrapper's instinct: paste the whole twenty-row ranking into a table.*

![The last three rows spill onto a second slide stamped "(cont.)"](https://dev-to-uploads.s3.us-east-2.amazonaws.com/uploads/articles/s8r1ujslbgxrp98v3d57.png)

*It doesn't fit, so the last three rows get a slide of their own, stamped "(cont.)".*
...
![No wrapper: the same ranking as a chart, one bar in the accent color, the rest grayed out](https://dev-to-uploads.s3.us-east-2.amazonaws.com/uploads/articles/xffqf2d2hqxypbll3td0.png)

*No wrapper: the same ranking as a chart, one bar in the accent color, a heading that makes a point.*
