...
<!-- TITLE LOCKED (Saad, 2026-06-29). Cover line is separate: "The agent gets one key, and never
     the real one" (lives on the cover image, not the post title). -->
