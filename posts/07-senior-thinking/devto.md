...
published: false
description: Thinking like a senior developer is a habit, and I learned it the hard way. Eleven parts of it, with the story behind each one: the form nobody questioned, the seven categories that became 43, the Stripe webhook race, the key that could mint authority.
